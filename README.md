...
> Answer: Client side routing allows for faster page change loading times, as well as faster and smoother animations due to no server fetching needed since its all on the internal JS that is on the page already.
